...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new TedPermission(this)
                ...
                .setDeniedMessage("스마트폰의 본인 인증을 위해 전화 권한을 허용해야 합니다.\n\n[설정]-[애플리케이션 관리자]에 가셔서 해당 앱의 전화 권한을 활성화 해 주세요.")
    ...
    public void pass_ok(View v) {
        ...
        if (num_01 == 1) { // editText3(num_01)이 1234이랑 같는지 판단.
            Intent intent_01 = new Intent(getApplication(), MainActivity.class);
